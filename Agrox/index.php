      ...
      <div class="wrapper">
        ...
        <div class="wrapper">
          <section class="col1"> <span class="dropcap1"><span>a</span></span>
            <div class="cols">
              <p class="pad_bot1 color1">Agriot is one of free website templates created by TemplateMonster.com team.</p>
              <p class="pad_bot2">This website template is opti- mized for 1024X768 screen res. It is also XHTML &amp; CSS valid.</p>
              <a href="#" class="link1">Read More</a> </div>
          </section>
          <section class="col1 pad_left1"> <span class="dropcap1"><span class="color1">b</span></span>
            <div class="cols">
              <p class="pad_bot1 color1">This Agrox Template goes with two packages – with PSD source files and without them.</p>
          ...
          <section class="col1 pad_left1"> <span class="dropcap1"><span class="color2">c</span></span>
            <div class="cols">
              <p class="pad_bot1 color1">This Agrox website template has several pages:</p>
              <p class="pad_bot2"><a href="index.jsp" class="link2">Home Page</a>, <a href="products.html" class="link2">Products Page</a>, <a href="technology.html" class="link2">Technology</a>, <a href="pricing.html" class="link2">Pricing</a>, <a href="contact.html" class="link2">Contact Us</a> (note that contact us form – doesn’t work).</p>
              <a href="#" class="link1">Read More</a> </div>
          </section>
        </div>
      </div>
